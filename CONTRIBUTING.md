...
3. Publish that exact archive to npm with public access.
4. Update the formula URL and SHA-256 digest. Homebrew infers the version from
   the URL.
5. Run the full checks above and merge only after CI passes.
